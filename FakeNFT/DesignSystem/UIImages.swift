...
extension UIImage {
    ...
    static let ypProfileNftRatingImage0 = UIImage(named: "Rating_0") ?? UIImage()
    static let ypProfileNftRatingImage1 = UIImage(named: "Rating_1") ?? UIImage()
    static let ypProfileNftRatingImage2 = UIImage(named: "Rating_2") ?? UIImage()

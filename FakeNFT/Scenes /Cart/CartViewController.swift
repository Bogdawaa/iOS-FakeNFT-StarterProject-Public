...
final class CartViewController: UIViewController {
    ...
    private lazy var paymentButton: UIButton = {
        let button = UIButton()
        button.setTitle(NSLocalizedString("Cart.Button.toPay", comment: ""), for: .normal)
    ...
    private lazy var deleteButton: UIButton = {
        ...
        button.setTitle(NSLocalizedString("Cart.Button.Delete", comment: ""), for: .normal)
    ...
    private lazy var cancelButton: UIButton = {
        ...
        button.layer.cornerRadius = 12
        button.titleLabel?.font = UIFont.bodyRegular
        button.setTitle(NSLocalizedString("Cart.Button.Return", comment: ""), for: .normal)
        button.setTitleColor(UIColor(named: "YPWhite"), for: .normal)
        button.backgroundColor = UIColor(named: "YPBlack")
    ...
    override func viewDidLoad() {
        ...
        sortPresenter = SortPresenter(viewControler: self)
        configViews()
        configConstraints()
    }
    ...
    private func bind() {
        ...
        viewModel.$loadingErrorNFT.bind(observer: { [weak self] _ in
            guard let self else { return }
...
extension CartViewController {
    ...
    private func showAlertNetworkError() {
        ...
        let alert = AlertModel(
            title: NSLocalizedString("Failed.toLoad.cart", comment: ""),

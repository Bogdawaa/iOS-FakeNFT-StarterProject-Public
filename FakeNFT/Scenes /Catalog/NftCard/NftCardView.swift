...
protocol NftCardViewDelegate: AnyObject {
    ...
    func rowData(at indexPath: IndexPath) -> Currency?
    func didSelectRow(at indexPath: IndexPath)
}

final class NftCardView: UIView, LoadingView {
...
extension NftCardView: UITableViewDataSource {
...
extension NftCardView: UITableViewDelegate {
